...
description: Complete list of Discord Activity Application IDs.
---

# 🎮 Discord Activity IDs

Use these activity application IDs to launch embedded Discord games and apps via bots or Discord integrations.
...
💡 You can launch these with Discord bots using the [StartActivity](https://discord.com/developers/docs/resources/channel#start-thread-with-message-json-params) endpoint or a library that supports embedded activities.
